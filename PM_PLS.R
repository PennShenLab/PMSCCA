PM_PLS<-function(X, Y, E, standardize="Center", lambda=0.25, u0=NULL,v0=NULL, maxiter=100, tolvar=10e-4, tolfun=10e-6, QUIET=F,autoT=F){
  # --------------------------------------------------------------------
  # PM-SPLS algorithm 
  # --------------------------------------------------------------------
  ...
  parasStandardize[["init.params"]] <- list(lambda = lambda,
                                            u0 = u,
                                            v0 = v)
